...
const CitizenSidebar = ({ activeItem = 'Dashboard', setActiveItem, onLogout, isOpen = false, onClose }) => {
            ...
            >
                ...
                <div className="p-4 border-b border-emerald-100/80 bg-emerald-50/50">
                    ...
                    <div className="flex items-center gap-3">
                        <div className="w-12 h-12 rounded-full bg-[#0a4d2c] flex items-center justify-center shadow-md text-white font-bold text-lg">
                            {userName[0] ? userName[0].toUpperCase() : <User className="w-6 h-6 text-white" />}
                        </div>
                        ...
                        <div>
                            ...
                            <h2 className="text-[11px] uppercase tracking-wider text-[#0a4d2c] font-bold">
                                Citizen Panel
                            </h2>
                        </div>
                    </div>
