...
const CitizenSidebar = ({
  ...
  const mainMenuItems = [
    ...
    { id: 'AI Assistant', label: 'Mittu AI Chat', icon: Bot },
  ];
  ...
  return (
    <>
      ...
      >
        {/* Top Fixed Section: User Profile & Menu Toggle in One Line */}
        <div className="shrink-0 px-2.5 pt-3 pb-2 bg-white dark:bg-[#181b20]">
          ...
          >
            {/* User Info (Avatar + Akshay Krishnan) */}
            ...
            <div className="flex items-center shrink-0">
              <button
                ...
                className="hidden lg:flex items-center justify-center p-1.5 rounded-lg hover:bg-emerald-50 dark:hover:bg-white/10 text-[#064e3b] dark:text-emerald-400 transition-colors cursor-pointer"
              ...
              <button
                onClick={onClose}
                className="p-1.5 rounded-lg hover:bg-gray-100 dark:hover:bg-white/10 text-gray-500 lg:hidden shrink-0"
                title="Close menu"
              >
                <X className="w-4 h-4" />
              </button>
                    ...
                    {!isCollapsed && (
                      <span
                        className={`text-[12.5px] font-semibold truncate ${
                          isActive ? 'text-white font-bold' : 'text-gray-700 dark:text-gray-300 group-hover:text-gray-900 dark:group-hover:text-white'
                        }`}
                      >
                        {item.label}
                      </span>
